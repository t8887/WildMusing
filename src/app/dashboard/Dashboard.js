      ...
      <div>
        ...
        <div className="row">
          <div className="col-md-8 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-0">Statistics Overview</h4>
                <div className="d-xl-flex flex-column flex-lg-row">
                  ...
                  >
                    <li className="nav-item">
                      <button
                        className={`nav-link ${this.state.active === "sales-statistics_switch_1"
                          ? "active"
                          : ""
                          }`}
                    ...
                    <li className="nav-item">
                      <button
                        className={`nav-link ${this.state.active === "sales-statistics_switch_2"
                          ? "active"
                          : ""
                          }`}
                    ...
                    <li className="nav-item">
                      <button
                        className={`nav-link ${this.state.active === "sales-statistics_switch_3"
                          ? "active"
                          : ""
                          }`}
                    ...
                    <li className="nav-item">
                      <button
                        className={`nav-link ${this.state.active === "sales-statistics_switch_4"
                          ? "active"
                          : ""
                          }`}
