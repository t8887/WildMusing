...
export default function WeftTable({ table }) {
                ...
                <TableBody>
                    {data.map((e) => (
                        <TableRow className={classes.root}>
                            ...
                            {table === "2" ? (
                                <TableCell className='tablerow'><i className="mdi mdi-file-document text-success" /></TableCell>
                            ) : (
                                <TableCell className='tablerow'>Qtr</TableCell>
                            )
                            }
                        </TableRow>
                    ))}
